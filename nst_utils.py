### Part of this code is due to the MatConvNet team and is used to 
#load the parameters of the pretrained VGG19 model in the notebook ###
import os
import sys
import scipy.io
import scipy.misc
...
class CONFIG:
    ...
    STYLE_IMAGE = 'image_Style/GOW.jpg' # Style image to use.
    CONTENT_IMAGE = 'image_Content/IMAX.jpg' # Content image to use.
    OUTPUT_DIR = 'image_Generated/'
